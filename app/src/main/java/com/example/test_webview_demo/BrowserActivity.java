...
public class BrowserActivity extends Activity {
    ...
    private void requestPermissions() {
        ...
        System.out.println("<><BrowserActivity.requestPermissions>+ + + + +");
    }

    private void requestPermission(String permission) {
        int hasWriteStoragePermission = ContextCompat.checkSelfPermission(getApplication(), permission);
        if (hasWriteStoragePermission != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(BrowserActivity.this, new String[]{permission}, CODE_FOR_WRITE_PERMISSION);
        }
    }
}
